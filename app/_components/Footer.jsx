                  ...
                  <li>
                    <a className="group flex gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="#">
                      ...
                      <span className="relative flex size-2">
                        ...
                        <span className="relative inline-flex size-2 rounded-full bg-gray-800"></span>
                      </span>
                    </a>
                  </li>
                </ul>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-700">owner@gmail.com</span>
                    </a>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-700">+91 95XXX XXXXX</span>
                    </a>
                  </li>
                  ...
                  >
                    ...
                    <address className="-mt-0.5 flex-1 not-italic text-gray-700">
                      GLA University Campus, Mathura, Uttar Pradesh, India
                    </address>
                  </li>
                </ul>
              </div>
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-gray-500">
                ...
                <a
                  className="inline-block text-gray-500 underline transition hover:text-gray-700/75"
                  href="#"
                >
                  Terms & Conditions
                </a>
