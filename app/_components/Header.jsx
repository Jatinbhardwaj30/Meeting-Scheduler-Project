          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:block">
              <nav aria-label="Global">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-500/75" href="#"> About </a>
                  </li>

                  <li>
                    <a className="text-gray-700 transition hover:text-gray-500/75" href="#"> Features </a>
                  </li>

                  <li>
                    <a className="text-gray-700 transition hover:text-gray-500/75" href="#"> Services </a>
                  </li>

                  <li>
                    <a className="text-gray-700 transition hover:text-gray-500/75" href="#"> Schedule </a>
                  </li>
                  ...
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-500/75" href="#"> Contact Us </a>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <LoginLink><Button
                  className="rounded-md bg-black px-5 py-2.5 text-sm font-medium text-white shadow hover:bg-gray-400 hover:text-white"
                > 
                  Login
                  <LogIn/>
                </Button></LoginLink>
                ...
                <div className="hidden sm:flex">
                  <RegisterLink><Button
                    className="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black hover:bg-gray-400 hover:text-white"
                  >
                    Get Started
                  </Button>
                  </RegisterLink>
